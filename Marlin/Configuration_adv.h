 ...
 */
#define E0_AUTO_FAN_PIN 28
#define E1_AUTO_FAN_PIN 28
...
#define FWRETRACT  //ONLY PARTIALLY TESTED
  ...
  #define RETRACT_LENGTH 30              //default retract length (positive mm)
  #define RETRACT_LENGTH_SWAP 40         //default swap retract length (positive mm), for extruder change
